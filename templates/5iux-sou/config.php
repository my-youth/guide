...
<div class="layui-row" style = "margin-top:18px;">
    ...
    <input type="url" id = "backgroundURL" name="backgroundURL" value = "<?php echo getconfig($config.'backgroundURL','https://www.dmoe.cc/random.php');?>" placeholder="请输入图片URL" autocomplete="off" class="layui-input">
    </div>
    </div>
    
    <div class="layui-form-item">
    <label class="layui-form-label">内页标题</label>
    <div class="layui-input-inline">
      <input type="txt" id = "title" name="title" value = "<?php echo getconfig($config.'title','上网，从这里开始！');?>" placeholder="" autocomplete="off" class="layui-input">
    </div>
    <div class="layui-form-mid layui-word-aux">搜索框上面的文字</div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-form-mid layui-word-aux">天气插件开关</div>
    </div>
    <div class="layui-form-item">
